...
syn region ebslMacro start=/^\s*\zs/ end=/$/ contains=ebslMacroStatement,ebslMacroQualifier
syn match ebslMacroStatement /\%(FOR\|END\)_\(\w\|\.\)*/ contained
...
hi def link ebslMacroStatement Keyword
