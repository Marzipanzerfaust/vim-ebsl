...
syn keyword ebslKeyword BEGIN BY CALL CALL_SCREEN CASE CDD CONTINUE CONVAFTER CONVERT CRT DO ELSE END EXIT FIND FINDSTR FOR GOSUB IF IGNORE IN LOCATE LOCKED LOOP NEXT PRINT PROCEDURE PROGRAM PROMPT PROMPT_IN_PLACE PROMPT_WIDE REPEAT REPROMPT RETURN SETTING STEP SUBROUTINE SWAP THEN TO TRANSLATE UNTIL WHILE
